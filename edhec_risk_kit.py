...
def get_ind_returns():
    ...
    try:
        ind = pd.read_csv("/kaggle/input/edhec-investment-management-datasets/ind30_m_vw_rets.csv", header=0, index_col=0,
...
def get_brka_rets(monthly=False):
    ...
    '''
    filepath = "/kaggle/input/edhec-investment-management-datasets/brka_d_ret.csv"
...
def get_fff_returns():
    ...
    '''
    filepath = "/kaggle/input/edhec-investment-management-datasets/F-F_Research_Data_Factors_m.csv"
...
def get_ind_file(filetype="rets", nind=30, ew=False):
    ...
    filepath = "/kaggle/input/edhec-investment-management-datasets/" + "ind{}_m_{}.csv" .format(nind, name)
